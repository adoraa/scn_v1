          ...
          <div className="flex items-start justify-between">
            ...
            <div className="ml-3 flex h-7 items-center ">
              <button
                ...
                className="relative -m-2 py-1 px-2 bg-accent text-white rounded-md hover:bg-red-500 transition-all duration-200  "
              >
                        ...
                        <div className="flex flex-1 flex-wrap items-end justify-between space-y-2 text-sm">
                          ...
                          <div className="flex">
                            <button
                              ...
                              type="button"
                              className="font-medium text-accent hover:text-dark"
                            >
                              Remove
                            </button>
                          </div>
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
          ...
          <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
            <Link to="/">
              ...
              <button
                type="button"
                className="font-medium text-primary hover:text-accent ml-1"
              >
                Continue Shopping
